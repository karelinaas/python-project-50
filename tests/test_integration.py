...
def test_diff_with_complex_json_files():
    """
    Тестирует diff с использованием сложных
    JSON файлов с вложенными структурами.
    """
...
def test_parse_all_test_files():
    ...
    for filename in test_files:
        ...
        assert isinstance(data, dict), (
            f"Файл {filename} должен содержать словарь"
        )
...
def test_diff_consistency_between_json_and_yaml():
    """
    Проверяет, что diff для JSON и YAML версий одинаковых данных дает
